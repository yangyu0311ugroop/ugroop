...
describe('<Address />', () => {
  ...
  beforeEach(() => {
    ...
    rendered = shallow(<Address {...props} />);
  ...
  describe('handleDiscard()', () => {
    ...
    it('should handleDiscard', () => {
      ...
      instance.goOrgInfo = jest.fn(() => 'goPersonalInfo');
  ...
  describe('handleChangeLocation()()', () => {
    it('should handleChangeLocation()', () => {
      instance.handleChangeLocation('placeId')('test');
      expect(instance.placeId).toEqual('test');
    });
    it('should return null', () => {
      instance.handleChangeLocation('some value')('test');
      expect(instance.placeId).toEqual(undefined);
    });
  });
