...
export class StudentDetailYear extends React.PureComponent {
  renderTextOnly = () => {
...
StudentDetailYear.defaultProps = {
  variant: '',

  value: '',
};

export default resaga(CONFIG)(StudentDetailYear);
