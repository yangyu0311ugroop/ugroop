...
export class MedicalCreate extends React.PureComponent {
  state = {
    editing: false,
    loading: false,
    anchorEl: null,
  ...
  renderForm = () => (
    <GridContainer direction="column">
      ...
      <GridItem>{this.renderPart(Medical, VARIANTS.FORM)}</GridItem>
...
MedicalCreate.defaultProps = {
  id: null,
};

export default compose(
  withStyles(style, { name: 'smartComponents/Person/Medical/Create' }),
  resaga(),
)(MedicalCreate);
