...
export class DietaryDescription extends React.PureComponent {
  renderTextOnly = () => {
...
DietaryDescription.defaultProps = {
  variant: '',
...
export default compose(
  withStyles(style, {
    name: 'smartComponents/Person/parts/Dietary/Description',
  }),
  resaga(CONFIG),
)(DietaryDescription);
