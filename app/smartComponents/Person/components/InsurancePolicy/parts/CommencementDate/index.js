...
export const CommencementDate = props => {
  ...
  const renderTextWithLabel = () => (
    <EditableDateForm
      ...
      value={value}
      readOnly={readOnly}
      placeholder="Click to specify Commencement Date"
      readOnlyPlaceholder="No Commencement Date"
      onSubmit={onSubmit}
...
export default CommencementDate;
