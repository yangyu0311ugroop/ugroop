...
export const CONFIG = {
  value: {
    ...
    middleName: PERSON_STORE_HELPERS.selectPersonProperty({
      [USER_DATA_STORE]: USER_STORE_SELECTORS.middleName,
      [PERSON_DATA_STORE]: PERSON_STORE_SELECTORS.middleName,
    }),
