...
describe('config', () => {
  describe('CONFIG_1', () => {
    describe('value', () => {
      ...
      it('should have personType', () => {
        expect(CONFIG_1.value.personType({ id: 1 })).toEqual(
    ...
    describe('value', () => {
      describe('userValues', () => {
        it('should have keyPath', () => {
          ...
          ).toEqual(PERSON_STORE_SELECTORS.studentDetails({ id: 1 }));
        });
        it('should have cacheKey', () => {
          expect(
            CONFIG_2.value.userValues.cacheKey({ userPersonId: 1 }),
          ).toEqual(`Node.parts.StudentDetails.${1}.userValues`);
        });
        it('should have null props', () => {
