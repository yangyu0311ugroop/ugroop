    ...
    describe('value', () => {
      describe('userValues', () => {
        it('should have keyPath', () => {
          ...
          ).toEqual(PERSON_STORE_SELECTORS.medicals({ id: 1 }));
        });
        it('should have cacheKey', () => {
          expect(
            CONFIG_2.value.userValues.cacheKey({ userPersonId: 1 }),
          ).toEqual(`Node.parts.Medicals.${1}.userValues`);
        });
        it('should have null props', () => {
