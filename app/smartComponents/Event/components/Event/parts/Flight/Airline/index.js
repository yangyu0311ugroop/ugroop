...
export class Airline extends React.PureComponent {
  handleSubmit = obj => {
  ...
  renderField = () => {
    ...
    return (
      <GridItem xs={12} sm>
        <Text value={value} {...inputs.airline} />
      </GridItem>
    );
  };
...
export default compose(
  EVENT_STORE_HOC.selectEventProp({ path: EVENT_PATHS.airline }),
)(Airline);
