...
describe('<CardsAPI />', () => {
  ...
  beforeEach(() => {
    rendered = shallow(<CustomerAPI {...props} />);
  ...
  describe('getCustomerSuccess()', () => {
    it('getCustomerSuccess', () => {
      instance.getCustomerSuccess();
    });
  });
  describe('updateCustomerSuccess()', () => {
    it('updateCustomerSuccess', () => {
      instance.updateCustomerSuccess();
    });
  });
});
